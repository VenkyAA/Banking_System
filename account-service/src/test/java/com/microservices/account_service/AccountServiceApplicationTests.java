...
public class AccountServiceApplicationTests {
    ...
    @BeforeEach
    void setUp() {
        accountDTO = new AccountDTO(1L, "Venkat", 30000.0, "USER"); // Ensure role is either "USER" or "ADMIN"
        account = new Account(1L, "Venkat", 30000.0, "USER"); // Ensure role is either "USER" or "ADMIN"
